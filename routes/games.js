...
const supportedGames = {
  ...
  'ganesha-fortune': 'Ganesha Fortune',
  'dreams-of-macau': 'Dreams of Macau',
  'double-fortune': 'Double Fortune',
  'queen-of-bounty': 'Queen of Bounty',
  'leprechaun-riches': 'Leprechaun Riches',
  'captains-bounty': "Captain's Bounty",
  'dragon-hatch': 'Dragon Hatch',
  'phoenix-rises': 'Phoenix Rises',
  'ways-of-the-qilin': 'Ways of the Qilin',
  'candy-burst': 'Candy Burst',
  'muay-thai-champion': 'Muay Thai Champion',
  'dragon-tiger-luck': 'Dragon Tiger Luck',
  'gem-saviour-sword': 'Gem Saviour Sword',
  ...
  'speed-baccarat': 'Speed Baccarat',
  'immersive-roulette': 'Immersive Roulette',
  'casino-holdem': "Casino Hold'em",
  'super-sic-bo': 'Super Sic Bo',
  'dragon-tiger-live': 'Dragon Tiger Live',
  'fan-tan': 'Fan Tan',
  'bac-bo': 'Bac Bo',
  'peek-baccarat': 'Peek Baccarat',
  'golden-wealth': 'Golden Wealth',
  'football-studio': 'Football Studio',
  'side-bet-city': 'Side Bet City',
  'gonzos-hunt': "Gonzo's Hunt",
  ...
  'crazy-seven': 'Crazy Seven',
  'charge-buffalo': 'Charge Buffalo',
  'jungle-king': 'Jungle King',
  'roma': 'Roma',
